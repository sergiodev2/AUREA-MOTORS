    ...
    <main className="min-h-screen flex flex-col">
        ...
        <div className="relative z-10 container text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-300">
            <Button size="lg" variant="luxury" asChild>
              <Link href="/inventory" className="text-lg px-8 uppercase tracking-wider">{t('view_collection')}</Link>
            </Button>
            <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10" asChild>
              <Link href="/contact" className="text-lg px-8 uppercase tracking-wider">{t('contact_us')}</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 container mx-auto">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="font-serif text-4xl font-medium mb-2">{t('featured_models')}</h2>
            <p className="text-muted-foreground">{t('latest_desc')}</p>
          </div>
          <Button variant="link" asChild className="hidden md:flex">
            <Link href="/inventory">{t('view_all_inventory')} <ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
      ...
      <section id="services" className="py-24 bg-secondary/10 border-y border-white/5">
        <div className="container mx-auto px-4">
          <h2 className="font-serif text-4xl font-medium text-center mb-16">{t('services_title')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold uppercase tracking-wide">{t('service_financing_title')}</h3>
              <p className="text-muted-foreground">{t('service_financing_desc')}</p>
            </div>
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold uppercase tracking-wide">{t('service_warranty_title')}</h3>
              <p className="text-muted-foreground">{t('service_warranty_desc')}</p>
            </div>
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold uppercase tracking-wide">{t('service_tradein_title')}</h3>
              <p className="text-muted-foreground">{t('service_tradein_desc')}</p>
            </div>
          </div>
        </div>
      </section>
